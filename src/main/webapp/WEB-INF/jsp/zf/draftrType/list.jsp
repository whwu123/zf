...
<body class="gray-bg">
	...
	<t:datagrid actionUrl="draftrType/datagrid" tableContentId="jqGrid_wrapper" searchGroupId="searchGroupId" fit="true" caption="类型管理" name="table_list_2" pageSize="20" sortName="sort" sortOrder="asc">
		...
		<t:dgDelOpt label="删除" url="draftrType/del?id={id}" operationCode="sys:user:del"/>
		<t:dgToolBar url="draftrType/addorupdate" type="add" width="40%" height="30%" operationCode="sys:user:add"></t:dgToolBar>
		<t:dgToolBar url="draftrType/addorupdate" type="edit" width="40%" height="30%" operationCode="sys:user:edit"></t:dgToolBar>
	</t:datagrid>
